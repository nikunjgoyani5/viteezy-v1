...
angular.module("app.pages.quiz-v2.diet-type", [])
  .config(["$stateProvider", function ($stateProvider) {
    $stateProvider
      .state("diet-type", {
        url: "/quiz-v2/diet-type",
        controller: "DietTypeController",
        controllerAs: "vm",
        bindToController: true,
        templateUrl: "app/js/modules/pages/quiz-v2/quiz-questions/diet-type/diet-type.html",
        role: "anonymous",
        type: "question"
      });
  }])

  .controller("DietTypeController", ["Quiz", "UserManager", "$state", "toast", "QuizAnimation", function (Quiz, UserManager, $state, toast, QuizAnimation) {
    this.questionConfig = {
      nextQuizState: "diet-intolerances",
      apiUrlKey: "diet-type",
      apiAnswerValueKey: "dietTypeId",
      answerId: undefined,
      currentProgress: 79
    };
