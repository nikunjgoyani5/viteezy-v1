...
public class AmountOfFiberConsumption {
    ...
    public AmountOfFiberConsumption(
    ...
    public boolean equals(Object o) {
        ...
        AmountOfFiberConsumption amountOfFiberConsumption = (AmountOfFiberConsumption) o;
        return Objects.equals(id, amountOfFiberConsumption.id) &&
                Objects.equals(name, amountOfFiberConsumption.name) &&
                Objects.equals(code, amountOfFiberConsumption.code) &&
                Objects.equals(isActive, amountOfFiberConsumption.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AmountOfFiberConsumption.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
