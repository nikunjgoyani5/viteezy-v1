...
public class PregnancyState {
    ...
    public boolean equals(Object o) {
        ...
        PregnancyState pregnancyState = (PregnancyState) o;
        return Objects.equals(id, pregnancyState.id) &&
                Objects.equals(name, pregnancyState.name) &&
                Objects.equals(code, pregnancyState.code) &&
                Objects.equals(isActive, pregnancyState.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", PregnancyState.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
