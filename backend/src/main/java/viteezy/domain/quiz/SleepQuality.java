...
public class SleepQuality {
    ...
    public boolean equals(Object o) {
        ...
        SleepQuality sleepQuality = (SleepQuality) o;
        return Objects.equals(id, sleepQuality.id) &&
                Objects.equals(name, sleepQuality.name) &&
                Objects.equals(code, sleepQuality.code) &&
                Objects.equals(isActive, sleepQuality.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", SleepQuality.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
