...
public class StressLevelCondition {
    ...
    public boolean equals(Object o) {
        ...
        StressLevelCondition that = (StressLevelCondition) o;
    ...
    public String toString() {
        return new StringJoiner(", ", StressLevelCondition.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
