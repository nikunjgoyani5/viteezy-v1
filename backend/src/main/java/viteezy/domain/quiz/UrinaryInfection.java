...
public class UrinaryInfection {
    ...
    public boolean equals(Object o) {
        ...
        UrinaryInfection urinaryInfection = (UrinaryInfection) o;
        return Objects.equals(id, urinaryInfection.id) &&
                Objects.equals(name, urinaryInfection.name) &&
                Objects.equals(code, urinaryInfection.code) &&
                Objects.equals(isActive, urinaryInfection.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", UrinaryInfection.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
