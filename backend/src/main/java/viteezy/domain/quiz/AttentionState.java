...
public class AttentionState {
    ...
    public boolean equals(Object o) {
        ...
        AttentionState attentionState = (AttentionState) o;
        return Objects.equals(id, attentionState.id) &&
                Objects.equals(name, attentionState.name) &&
                Objects.equals(code, attentionState.code) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AttentionState.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
