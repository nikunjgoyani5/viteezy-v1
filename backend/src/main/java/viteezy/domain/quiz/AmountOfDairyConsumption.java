...
public class AmountOfDairyConsumption {
    ...
    public AmountOfDairyConsumption(
    ...
    public boolean equals(Object o) {
        ...
        AmountOfDairyConsumption amountOfDairyConsumption = (AmountOfDairyConsumption) o;
        return Objects.equals(id, amountOfDairyConsumption.id) &&
                Objects.equals(name, amountOfDairyConsumption.name) &&
                Objects.equals(code, amountOfDairyConsumption.code) &&
                Objects.equals(isActive, amountOfDairyConsumption.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AmountOfDairyConsumption.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
