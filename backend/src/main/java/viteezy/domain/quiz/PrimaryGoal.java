...
public class PrimaryGoal {
    ...
    public boolean equals(Object o) {
        ...
        PrimaryGoal primaryGoal = (PrimaryGoal) o;
        return Objects.equals(id, primaryGoal.id) &&
                Objects.equals(name, primaryGoal.name) &&
                Objects.equals(code, primaryGoal.code) &&
                Objects.equals(isActive, primaryGoal.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", PrimaryGoal.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
