...
public class StressLevel {
    ...
    public boolean equals(Object o) {
        ...
        StressLevel stressLevel = (StressLevel) o;
        return Objects.equals(id, stressLevel.id) &&
                Objects.equals(name, stressLevel.name) &&
                Objects.equals(code, stressLevel.code) &&
                Objects.equals(isActive, stressLevel.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", StressLevel.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
