...
public class EasternMedicineOpinion {
    ...
    public boolean equals(Object o) {
        ...
        EasternMedicineOpinion that = (EasternMedicineOpinion) o;
    ...
    public String toString() {
        return new StringJoiner(", ", EasternMedicineOpinion.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
