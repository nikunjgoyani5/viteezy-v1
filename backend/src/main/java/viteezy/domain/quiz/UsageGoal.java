...
public class UsageGoal {
    ...
    public boolean equals(Object o) {
        ...
        UsageGoal usageGoal = (UsageGoal) o;
        return Objects.equals(id, usageGoal.id) &&
                Objects.equals(name, usageGoal.name) &&
                Objects.equals(code, usageGoal.code) &&
                Objects.equals(isActive, usageGoal.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", UsageGoal.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
