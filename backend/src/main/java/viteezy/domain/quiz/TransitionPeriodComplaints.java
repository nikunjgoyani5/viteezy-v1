...
public class TransitionPeriodComplaints {
    ...
    public TransitionPeriodComplaints(
    ...
    public boolean equals(Object o) {
        ...
        TransitionPeriodComplaints transitionPeriodComplaints = (TransitionPeriodComplaints) o;
        return Objects.equals(id, transitionPeriodComplaints.id) &&
                Objects.equals(name, transitionPeriodComplaints.name) &&
                Objects.equals(code, transitionPeriodComplaints.code) &&
    ...
    public String toString() {
        return new StringJoiner(", ", TransitionPeriodComplaints.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
