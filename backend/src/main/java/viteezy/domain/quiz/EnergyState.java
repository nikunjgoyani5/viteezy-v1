...
public class EnergyState {
    ...
    public boolean equals(Object o) {
        ...
        EnergyState energyState = (EnergyState) o;
        return Objects.equals(id, energyState.id) &&
                Objects.equals(name, energyState.name) &&
                Objects.equals(code, energyState.code) &&
                Objects.equals(isActive, energyState.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", EnergyState.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
