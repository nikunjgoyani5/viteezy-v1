...
public class AllergyType {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, allergyType.id) &&
                Objects.equals(name, allergyType.name) &&
                Objects.equals(code, allergyType.code) &&
                Objects.equals(isActive, allergyType.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AllergyType.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
