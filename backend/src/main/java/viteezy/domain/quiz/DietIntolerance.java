...
public class DietIntolerance {
    ...
    public boolean equals(Object o) {
        ...
        DietIntolerance dietIntolerance = (DietIntolerance) o;
        return Objects.equals(id, dietIntolerance.id) &&
                Objects.equals(name, dietIntolerance.name) &&
                Objects.equals(code, dietIntolerance.code) &&
                Objects.equals(isActive, dietIntolerance.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", DietIntolerance.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
