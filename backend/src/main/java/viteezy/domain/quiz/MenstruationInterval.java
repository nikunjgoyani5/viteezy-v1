...
public class MenstruationInterval {
    ...
    public boolean equals(Object o) {
        ...
        MenstruationInterval menstruationInterval = (MenstruationInterval) o;
        return Objects.equals(id, menstruationInterval.id) &&
                Objects.equals(name, menstruationInterval.name) &&
                Objects.equals(code, menstruationInterval.code) &&
    ...
    public String toString() {
        return new StringJoiner(", ", MenstruationInterval.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
