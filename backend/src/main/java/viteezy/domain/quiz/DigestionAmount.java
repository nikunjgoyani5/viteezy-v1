...
public class DigestionAmount {
    ...
    public boolean equals(Object o) {
        ...
        DigestionAmount digestionAmount = (DigestionAmount) o;
        return Objects.equals(id, digestionAmount.id) &&
                Objects.equals(name, digestionAmount.name) &&
                Objects.equals(code, digestionAmount.code) &&
                Objects.equals(isActive, digestionAmount.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", DigestionAmount.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
