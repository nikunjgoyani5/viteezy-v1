...
public class TrainingIntensively {
    ...
    public boolean equals(Object o) {
        ...
        TrainingIntensively trainingIntensively = (TrainingIntensively) o;
        return Objects.equals(id, trainingIntensively.id) &&
                Objects.equals(name, trainingIntensively.name) &&
                Objects.equals(code, trainingIntensively.code) &&
                Objects.equals(isActive, trainingIntensively.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", TrainingIntensively.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
