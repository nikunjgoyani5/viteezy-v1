...
public class HealthComplaints {
    ...
    public boolean equals(Object o) {
        ...
        HealthComplaints healthComplaints = (HealthComplaints) o;
        return Objects.equals(id, healthComplaints.id) &&
                Objects.equals(name, healthComplaints.name) &&
                Objects.equals(code, healthComplaints.code) &&
                Objects.equals(isActive, healthComplaints.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", HealthComplaints.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
