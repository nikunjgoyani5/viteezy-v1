...
public class StressLevelAtEndOfDay {
    ...
    public boolean equals(Object o) {
        ...
        StressLevelAtEndOfDay that = (StressLevelAtEndOfDay) o;
    ...
    public String toString() {
        return new StringJoiner(", ", StressLevelAtEndOfDay.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
