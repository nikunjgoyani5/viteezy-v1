...
public class IronPrescribed {
    ...
    public boolean equals(Object o) {
        ...
        IronPrescribed ironPrescribed = (IronPrescribed) o;
        return Objects.equals(id, ironPrescribed.id) &&
                Objects.equals(name, ironPrescribed.name) &&
                Objects.equals(code, ironPrescribed.code) &&
                Objects.equals(isActive, ironPrescribed.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", IronPrescribed.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
