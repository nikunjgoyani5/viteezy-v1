...
public class BingeEating {
    ...
    public boolean equals(Object o) {
        ...
        BingeEating bingeEating = (BingeEating) o;
        return Objects.equals(id, bingeEating.id) &&
                Objects.equals(name, bingeEating.name) &&
                Objects.equals(code, bingeEating.code) &&
                Objects.equals(isActive, bingeEating.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", BingeEating.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
