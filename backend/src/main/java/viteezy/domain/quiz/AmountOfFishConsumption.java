...
public class AmountOfFishConsumption {
    ...
    public AmountOfFishConsumption(
    ...
    public boolean equals(Object o) {
        ...
        AmountOfFishConsumption amountOfFishConsumption = (AmountOfFishConsumption) o;
        return Objects.equals(id, amountOfFishConsumption.id) &&
                Objects.equals(name, amountOfFishConsumption.name) &&
                Objects.equals(code, amountOfFishConsumption.code) &&
                Objects.equals(isActive, amountOfFishConsumption.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AmountOfFishConsumption.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
