...
public class AcnePlace {
    ...
    public boolean equals(Object o) {
        ...
        AcnePlace acnePlace = (AcnePlace) o;
        return Objects.equals(id, acnePlace.id) &&
                Objects.equals(name, acnePlace.name) &&
                Objects.equals(code, acnePlace.code) &&
                Objects.equals(isActive, acnePlace.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AcnePlace.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
