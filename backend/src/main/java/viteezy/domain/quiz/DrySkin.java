...
public class DrySkin {
    ...
    public boolean equals(Object o) {
        ...
        DrySkin drySkin = (DrySkin) o;
        return Objects.equals(id, drySkin.id) &&
                Objects.equals(name, drySkin.name) &&
                Objects.equals(code, drySkin.code) &&
                Objects.equals(isActive, drySkin.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", DrySkin.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
