...
public class ThirtyMinutesOfSun {
    ...
    public boolean equals(Object o) {
        ...
        ThirtyMinutesOfSun thirtyMinutesOfSun = (ThirtyMinutesOfSun) o;
        return Objects.equals(id, thirtyMinutesOfSun.id) &&
                Objects.equals(name, thirtyMinutesOfSun.name) &&
                Objects.equals(code, thirtyMinutesOfSun.code) &&
                Objects.equals(isActive, thirtyMinutesOfSun.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", ThirtyMinutesOfSun.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
