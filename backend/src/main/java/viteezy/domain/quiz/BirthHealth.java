...
public class BirthHealth {
    ...
    public boolean equals(Object o) {
        ...
        BirthHealth birthHealth = (BirthHealth) o;
        return Objects.equals(id, birthHealth.id) &&
                Objects.equals(name, birthHealth.name) &&
                Objects.equals(code, birthHealth.code) &&
                Objects.equals(isActive, birthHealth.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", BirthHealth.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
