...
public class DailyFourCoffee {
    ...
    public boolean equals(Object o) {
        ...
        DailyFourCoffee dailyFourCoffee = (DailyFourCoffee) o;
        return Objects.equals(id, dailyFourCoffee.id) &&
                Objects.equals(name, dailyFourCoffee.name) &&
                Objects.equals(code, dailyFourCoffee.code) &&
                Objects.equals(isActive, dailyFourCoffee.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", DailyFourCoffee.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
