...
public class ChildrenWish {
    ...
    public boolean equals(Object o) {
        ...
        ChildrenWish childrenWish = (ChildrenWish) o;
        return Objects.equals(id, childrenWish.id) &&
                Objects.equals(name, childrenWish.name) &&
                Objects.equals(code, childrenWish.code) &&
                Objects.equals(isActive, childrenWish.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", ChildrenWish.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
