...
public class AttentionFocus {
    ...
    public boolean equals(Object o) {
        ...
        AttentionFocus attentionFocus = (AttentionFocus) o;
        return Objects.equals(id, attentionFocus.id) &&
                Objects.equals(name, attentionFocus.name) &&
                Objects.equals(code, attentionFocus.code) &&
    ...
    public String toString() {
        return new StringJoiner(", ", AttentionFocus.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
