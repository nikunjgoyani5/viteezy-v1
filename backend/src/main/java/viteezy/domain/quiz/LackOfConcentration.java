...
public class LackOfConcentration {
    ...
    public boolean equals(Object o) {
        ...
        LackOfConcentration lackOfConcentration = (LackOfConcentration) o;
        return Objects.equals(id, lackOfConcentration.id) &&
                Objects.equals(name, lackOfConcentration.name) &&
                Objects.equals(code, lackOfConcentration.code) &&
                Objects.equals(isActive, lackOfConcentration.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", LackOfConcentration.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
