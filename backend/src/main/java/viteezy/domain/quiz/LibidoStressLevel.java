...
public class LibidoStressLevel {
    ...
    public boolean equals(Object o) {
        ...
        LibidoStressLevel libidoStressLevel = (LibidoStressLevel) o;
        return Objects.equals(id, libidoStressLevel.id) &&
                Objects.equals(name, libidoStressLevel.name) &&
                Objects.equals(code, libidoStressLevel.code) &&
                Objects.equals(isActive, libidoStressLevel.isActive) &&
    ...
    public String toString() {
        return new StringJoiner(", ", LibidoStressLevel.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
