...
public class CustomerAddressPostRequest {
    ...
    @JsonCreator
    public CustomerAddressPostRequest(
    ...
    public boolean equals(Object o) {
        ...
        CustomerAddressPostRequest that = (CustomerAddressPostRequest) o;
    ...
    public String toString() {
        return new StringJoiner(", ", CustomerAddressPostRequest.class.getSimpleName() + "[", "]")
