...
public class HairTypePostRequest {
    ...
    public boolean equals(Object o) {
        ...
        HairTypePostRequest that = (HairTypePostRequest) o;
    ...
    public String toString() {
        return new StringJoiner(", ", HairTypePostRequest.class.getSimpleName() + "[", "]")
                .add("name='" + name + "'")
                .add("code='" + code + "'")
    ...
    public HairType to() {
        return new HairType(null, this.name, this.code, this.isActive, this.subtitle, LocalDateTime.now(), LocalDateTime.now());
    }
}