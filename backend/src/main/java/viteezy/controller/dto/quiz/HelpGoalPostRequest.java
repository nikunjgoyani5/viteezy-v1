...
public class HelpGoalPostRequest {
    ...
    public boolean equals(Object o) {
        ...
        HelpGoalPostRequest that = (HelpGoalPostRequest) o;
    ...
    public HelpGoal to() {
        return new HelpGoal(null, this.name, this.code, this.isActive, this.subtitle, LocalDateTime.now(), LocalDateTime.now());
    }
}