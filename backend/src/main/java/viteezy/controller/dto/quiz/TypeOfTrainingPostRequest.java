...
public class TypeOfTrainingPostRequest {
    ...
    @JsonCreator
    public TypeOfTrainingPostRequest(
    ...
    public boolean equals(Object o) {
        ...
        TypeOfTrainingPostRequest that = (TypeOfTrainingPostRequest) o;
    ...
    public String toString() {
        return new StringJoiner(", ", TypeOfTrainingPostRequest.class.getSimpleName() + "[", "]")
                .add("name='" + name + "'")
                .add("code='" + code + "'")
    ...
    public TypeOfTraining to() {
        return new TypeOfTraining(null, this.name, this.code, this.isActive, this.subtitle, LocalDateTime.now(), LocalDateTime.now());
    }
}