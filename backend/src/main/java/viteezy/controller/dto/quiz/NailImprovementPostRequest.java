...
public class NailImprovementPostRequest {
    ...
    @JsonCreator
    public NailImprovementPostRequest(
    ...
    public boolean equals(Object o) {
        ...
        NailImprovementPostRequest that = (NailImprovementPostRequest) o;
    ...
    public String toString() {
        return new StringJoiner(", ", NailImprovementPostRequest.class.getSimpleName() + "[", "]")
                .add("name='" + name + "'")
                .add("code='" + code + "'")
    ...
    public NailImprovement to() {
        return new NailImprovement(null, this.name, this.code, this.isActive, this.subtitle, LocalDateTime.now(), LocalDateTime.now());
    }
}