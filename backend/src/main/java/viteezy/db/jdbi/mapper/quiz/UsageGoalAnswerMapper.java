...
public class UsageGoalAnswerMapper implements RowMapper<UsageGoalAnswer> {

    @Override
    public UsageGoalAnswer map(ResultSet rs, StatementContext ctx) throws SQLException {
        final long id = rs.getLong("id");
        final long quizId = rs.getLong("quiz_id");
        final long usageGoalId = rs.getLong("usage_goal_id");
