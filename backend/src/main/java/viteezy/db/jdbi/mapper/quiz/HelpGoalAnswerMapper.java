...
public class HelpGoalAnswerMapper implements RowMapper<HelpGoalAnswer> {

    @Override
    public HelpGoalAnswer map(ResultSet rs, StatementContext ctx) throws SQLException {
        final long id = rs.getLong("id");
        final long quizId = rs.getLong("quiz_id");
        final long helpGoalId = rs.getLong("help_goal_id");
