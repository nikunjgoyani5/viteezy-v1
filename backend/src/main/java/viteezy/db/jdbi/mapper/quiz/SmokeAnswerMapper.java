...
public class SmokeAnswerMapper implements RowMapper<SmokeAnswer> {

    @Override
    public SmokeAnswer map(ResultSet rs, StatementContext ctx) throws SQLException {
        final long id = rs.getLong("id");
        final long quizId = rs.getLong("quiz_id");
        final long smokeId = rs.getLong("smoke_id");
