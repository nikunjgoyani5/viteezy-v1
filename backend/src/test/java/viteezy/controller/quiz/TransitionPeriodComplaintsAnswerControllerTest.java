...
class TransitionPeriodComplaintsAnswerControllerTest {
    ...
    private final TransitionPeriodComplaintsAnswerService service = Mockito.mock(TransitionPeriodComplaintsAnswerService.class);
    private TransitionPeriodComplaintsAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new TransitionPeriodComplaintsAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((TransitionPeriodComplaintsAnswerGetResponse)response.getEntity()).getId());
    ...
    void findByQuizExternalReferenceNotFound() {
        ...
        Assertions.assertThrows(NoSuchElementException.class, () -> {
            controller.getByQuizExternalReference(QUIZ_EXTERNAL_REFERENCE);
        });
