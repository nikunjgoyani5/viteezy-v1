...
class ChildrenWishAnswerControllerTest {
    ...
    private final ChildrenWishAnswerService service = Mockito.mock(ChildrenWishAnswerService.class);
    private ChildrenWishAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new ChildrenWishAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((ChildrenWishAnswerGetResponse)response.getEntity()).getId());
