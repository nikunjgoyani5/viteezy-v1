...
class DietTypeAnswerControllerTest {
    ...
    private final DietTypeAnswerService service = Mockito.mock(DietTypeAnswerService.class);
    private DietTypeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DietTypeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DietTypeAnswerGetResponse)response.getEntity()).getId());
