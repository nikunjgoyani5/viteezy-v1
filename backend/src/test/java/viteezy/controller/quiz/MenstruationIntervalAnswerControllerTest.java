...
class MenstruationIntervalAnswerControllerTest {
    ...
    private final MenstruationIntervalAnswerService service = Mockito.mock(MenstruationIntervalAnswerService.class);
    private MenstruationIntervalAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new MenstruationIntervalAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((MenstruationIntervalAnswerGetResponse)response.getEntity()).getId());
