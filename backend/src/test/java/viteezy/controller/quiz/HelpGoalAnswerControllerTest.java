...
class HelpGoalAnswerControllerTest {
    ...
    private final HelpGoalAnswerService service = Mockito.mock(HelpGoalAnswerService.class);
    private HelpGoalAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new HelpGoalAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((HelpGoalAnswerGetResponse)response.getEntity()).getId());
