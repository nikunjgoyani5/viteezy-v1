...
class AmountOfMeatConsumptionAnswerControllerTest {
    ...
    private final AmountOfMeatConsumptionAnswerService service = Mockito.mock(AmountOfMeatConsumptionAnswerService.class);
    private AmountOfMeatConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfMeatConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfMeatConsumptionAnswerGetResponse)response.getEntity()).getId());
