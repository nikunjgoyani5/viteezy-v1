...
class LoseWeightChallengeAnswerControllerTest {
    ...
    private final LoseWeightChallengeAnswerService service = Mockito.mock(LoseWeightChallengeAnswerService.class);
    private LoseWeightChallengeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new LoseWeightChallengeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((LoseWeightChallengeAnswerGetResponse)response.getEntity()).getId());
