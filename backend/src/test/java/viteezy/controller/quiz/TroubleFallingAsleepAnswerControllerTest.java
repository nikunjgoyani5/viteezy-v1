...
class TroubleFallingAsleepAnswerControllerTest {
    ...
    private final TroubleFallingAsleepAnswerService service = Mockito.mock(TroubleFallingAsleepAnswerService.class);
    private TroubleFallingAsleepAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new TroubleFallingAsleepAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((TroubleFallingAsleepAnswerGetResponse)response.getEntity()).getId());
