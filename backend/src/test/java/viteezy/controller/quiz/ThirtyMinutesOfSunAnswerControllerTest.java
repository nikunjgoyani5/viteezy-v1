...
class ThirtyMinutesOfSunAnswerControllerTest {
    ...
    private final ThirtyMinutesOfSunAnswerService service = Mockito.mock(ThirtyMinutesOfSunAnswerService.class);
    private ThirtyMinutesOfSunAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new ThirtyMinutesOfSunAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((ThirtyMinutesOfSunAnswerGetResponse)response.getEntity()).getId());
