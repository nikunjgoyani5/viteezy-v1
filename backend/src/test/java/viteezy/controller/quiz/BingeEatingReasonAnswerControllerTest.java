...
class BingeEatingReasonAnswerControllerTest {
    ...
    private final BingeEatingReasonAnswerService service = Mockito.mock(BingeEatingReasonAnswerService.class);
    private BingeEatingReasonAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new BingeEatingReasonAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((BingeEatingReasonAnswerGetResponse)response.getEntity()).getId());
