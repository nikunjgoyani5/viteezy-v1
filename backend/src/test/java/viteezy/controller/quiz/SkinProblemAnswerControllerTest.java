...
class SkinProblemAnswerControllerTest {
    ...
    private final SkinProblemAnswerService service = Mockito.mock(SkinProblemAnswerService.class);
    private SkinProblemAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SkinProblemAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SkinProblemAnswerGetResponse)response.getEntity()).getId());
