...
class DailyFourCoffeeAnswerControllerTest {
    ...
    private final DailyFourCoffeeAnswerService service = Mockito.mock(DailyFourCoffeeAnswerService.class);
    private DailyFourCoffeeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DailyFourCoffeeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DailyFourCoffeeAnswerGetResponse)response.getEntity()).getId());
