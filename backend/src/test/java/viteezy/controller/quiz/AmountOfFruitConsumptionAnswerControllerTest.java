...
class AmountOfFruitConsumptionAnswerControllerTest {
    ...
    private final AmountOfFruitConsumptionAnswerService service = Mockito.mock(AmountOfFruitConsumptionAnswerService.class);
    private AmountOfFruitConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfFruitConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfFruitConsumptionAnswerGetResponse)response.getEntity()).getId());
