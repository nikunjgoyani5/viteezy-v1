...
class TrainingIntensivelyAnswerControllerTest {
    ...
    private final TrainingIntensivelyAnswerService service = Mockito.mock(TrainingIntensivelyAnswerService.class);
    private TrainingIntensivelyAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new TrainingIntensivelyAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((TrainingIntensivelyAnswerGetResponse)response.getEntity()).getId());
