...
class HairTypeAnswerControllerTest {
    ...
    private final HairTypeAnswerService service = Mockito.mock(HairTypeAnswerService.class);
    private HairTypeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new HairTypeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((HairTypeAnswerGetResponse)response.getEntity()).getId());
