...
class NewProductAvailableAnswerControllerTest {
    ...
    private final NewProductAvailableAnswerService service = Mockito.mock(NewProductAvailableAnswerService.class);
    private NewProductAvailableAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new NewProductAvailableAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((NewProductAvailableAnswerGetResponse)response.getEntity()).getId());
