...
class BirthHealthAnswerControllerTest {
    ...
    private final BirthHealthAnswerService service = Mockito.mock(BirthHealthAnswerService.class);
    private BirthHealthAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new BirthHealthAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((BirthHealthAnswerGetResponse)response.getEntity()).getId());
