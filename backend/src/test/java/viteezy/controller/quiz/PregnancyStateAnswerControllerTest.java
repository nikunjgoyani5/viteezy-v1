...
class PregnancyStateAnswerControllerTest {
    ...
    private final PregnancyStateAnswerService service = Mockito.mock(PregnancyStateAnswerService.class);
    private PregnancyStateAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new PregnancyStateAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((PregnancyStateAnswerGetResponse)response.getEntity()).getId());
