...
class LackOfConcentrationAnswerControllerTest {
    ...
    private final LackOfConcentrationAnswerService service = Mockito.mock(LackOfConcentrationAnswerService.class);
    private LackOfConcentrationAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new LackOfConcentrationAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((LackOfConcentrationAnswerGetResponse)response.getEntity()).getId());
