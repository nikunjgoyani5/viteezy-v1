...
class WeeklyTwelveAlcoholicDrinksAnswerControllerTest {
    ...
    private final WeeklyTwelveAlcoholicDrinksAnswerService service = Mockito.mock(WeeklyTwelveAlcoholicDrinksAnswerService.class);
    private WeeklyTwelveAlcoholicDrinksAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new WeeklyTwelveAlcoholicDrinksAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((WeeklyTwelveAlcoholicDrinksAnswerGetResponse)response.getEntity()).getId());
