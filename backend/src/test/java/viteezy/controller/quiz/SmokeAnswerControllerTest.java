...
class SmokeAnswerControllerTest {
    ...
    private final SmokeAnswerService service = Mockito.mock(SmokeAnswerService.class);
    private SmokeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SmokeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SmokeAnswerGetResponse) response.getEntity()).getId());
