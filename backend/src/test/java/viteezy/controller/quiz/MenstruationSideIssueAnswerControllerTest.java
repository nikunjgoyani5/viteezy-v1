...
class MenstruationSideIssueAnswerControllerTest {
    ...
    private final MenstruationSideIssueAnswerService service = Mockito.mock(MenstruationSideIssueAnswerService.class);
    private MenstruationSideIssueAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new MenstruationSideIssueAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((MenstruationSideIssueAnswerGetResponse)response.getEntity()).getId());
