...
class AmountOfFiberConsumptionAnswerControllerTest {
    ...
    private final AmountOfFiberConsumptionAnswerService service = Mockito.mock(AmountOfFiberConsumptionAnswerService.class);
    private AmountOfFiberConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfFiberConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfFiberConsumptionAnswerGetResponse)response.getEntity()).getId());
