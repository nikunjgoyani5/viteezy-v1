...
class BingeEatingAnswerControllerTest {
    ...
    private final BingeEatingAnswerService service = Mockito.mock(BingeEatingAnswerService.class);
    private BingeEatingAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new BingeEatingAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((BingeEatingAnswerGetResponse)response.getEntity()).getId());
