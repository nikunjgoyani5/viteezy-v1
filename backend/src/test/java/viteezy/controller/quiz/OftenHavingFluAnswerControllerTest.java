...
class OftenHavingFluAnswerControllerTest {
    ...
    private final OftenHavingFluAnswerService service = Mockito.mock(OftenHavingFluAnswerService.class);
    private OftenHavingFluAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new OftenHavingFluAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((OftenHavingFluAnswerGetResponse)response.getEntity()).getId());
