...
class SportAmountAnswerControllerTest {
    ...
    private final SportAmountAnswerService service = Mockito.mock(SportAmountAnswerService.class);
    private SportAmountAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SportAmountAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SportAmountAnswerGetResponse)response.getEntity()).getId());
