...
class AcnePlaceAnswerControllerTest {
    ...
    private final AcnePlaceAnswerService service = Mockito.mock(AcnePlaceAnswerService.class);
    private AcnePlaceAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AcnePlaceAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AcnePlaceAnswerGetResponse)response.getEntity()).getId());
