...
class DigestionOccurrenceAnswerControllerTest {
    ...
    private final DigestionOccurrenceAnswerService service = Mockito.mock(DigestionOccurrenceAnswerService.class);
    private DigestionOccurrenceAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DigestionOccurrenceAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DigestionOccurrenceAnswerGetResponse)response.getEntity()).getId());
