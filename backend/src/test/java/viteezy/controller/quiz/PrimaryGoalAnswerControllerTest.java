...
class PrimaryGoalAnswerControllerTest {
    ...
    private final PrimaryGoalAnswerService service = Mockito.mock(PrimaryGoalAnswerService.class);
    private PrimaryGoalAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new PrimaryGoalAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((PrimaryGoalAnswerGetResponse)response.getEntity()).getId());
