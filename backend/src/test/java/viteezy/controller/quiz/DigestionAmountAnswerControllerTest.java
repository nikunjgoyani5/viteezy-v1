...
class DigestionAmountAnswerControllerTest {
    ...
    private final DigestionAmountAnswerService service = Mockito.mock(DigestionAmountAnswerService.class);
    private DigestionAmountAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DigestionAmountAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DigestionAmountAnswerGetResponse)response.getEntity()).getId());
