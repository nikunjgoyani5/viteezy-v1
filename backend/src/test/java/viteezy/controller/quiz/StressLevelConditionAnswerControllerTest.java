...
class StressLevelConditionAnswerControllerTest {
    ...
    private final StressLevelConditionAnswerService service = Mockito.mock(StressLevelConditionAnswerService.class);
    private StressLevelConditionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new StressLevelConditionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((StressLevelConditionAnswerGetResponse)response.getEntity()).getId());
