...
class EasternMedicineOpinionAnswerControllerTest {
    ...
    private final EasternMedicineOpinionAnswerService service = Mockito.mock(EasternMedicineOpinionAnswerService.class);
    private EasternMedicineOpinionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new EasternMedicineOpinionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((EasternMedicineOpinionAnswerGetResponse)response.getEntity()).getId());
