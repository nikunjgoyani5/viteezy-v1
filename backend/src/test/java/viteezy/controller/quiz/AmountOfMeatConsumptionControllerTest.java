...
class AmountOfMeatConsumptionControllerTest {
    ...
    private static final AmountOfMeatConsumptionPostRequest SAMPLE_ENTITY_DTO = new AmountOfMeatConsumptionPostRequest(NAME, CODE, true);

    private final AmountOfMeatConsumptionService service = Mockito.mock(AmountOfMeatConsumptionService.class);
    private AmountOfMeatConsumptionController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfMeatConsumptionController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getName(), ((AmountOfMeatConsumptionGetResponse) response.getEntity()).getName());
    ...
    void findAll() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(200, response.getStatus());
            Assertions.assertEquals(1, ((List<AmountOfMeatConsumptionGetResponse>) response.getEntity()).size());
            Assertions.assertEquals(SAMPLE_ENTITY.getName(), ((List<AmountOfMeatConsumptionGetResponse>) response.getEntity()).get(0).getName());
    ...
    void findAllEmpty() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            Response response = controller.getAll();
            Assertions.assertEquals(200, response.getStatus());
            Assertions.assertEquals(0, ((List<AmountOfMeatConsumption>) response.getEntity()).size());
    ...
    void save() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getName(), ((AmountOfMeatConsumption) response.getEntity()).getName());
