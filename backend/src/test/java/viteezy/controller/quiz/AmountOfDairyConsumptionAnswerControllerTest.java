...
class AmountOfDairyConsumptionAnswerControllerTest {
    ...
    private final AmountOfDairyConsumptionAnswerService service = Mockito.mock(AmountOfDairyConsumptionAnswerService.class);
    private AmountOfDairyConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfDairyConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfDairyConsumptionAnswerGetResponse)response.getEntity()).getId());
