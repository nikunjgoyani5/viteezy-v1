...
class SleepHoursLessThanSevenAnswerControllerTest {
    ...
    private final SleepHoursLessThanSevenAnswerService service = Mockito.mock(SleepHoursLessThanSevenAnswerService.class);
    private SleepHoursLessThanSevenAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SleepHoursLessThanSevenAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SleepHoursLessThanSevenAnswerGetResponse)response.getEntity()).getId());
