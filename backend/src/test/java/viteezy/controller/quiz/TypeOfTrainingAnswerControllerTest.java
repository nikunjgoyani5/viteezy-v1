...
class TypeOfTrainingAnswerControllerTest {
    ...
    private final TypeOfTrainingAnswerService service = Mockito.mock(TypeOfTrainingAnswerService.class);
    private TypeOfTrainingAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new TypeOfTrainingAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((TypeOfTrainingAnswerGetResponse)response.getEntity()).getId());
