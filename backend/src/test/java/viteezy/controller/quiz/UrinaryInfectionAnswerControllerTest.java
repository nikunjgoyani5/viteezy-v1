...
class UrinaryInfectionAnswerControllerTest {
    ...
    private final UrinaryInfectionAnswerService service = Mockito.mock(UrinaryInfectionAnswerService.class);
    private UrinaryInfectionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new UrinaryInfectionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((UrinaryInfectionAnswerGetResponse)response.getEntity()).getId());
