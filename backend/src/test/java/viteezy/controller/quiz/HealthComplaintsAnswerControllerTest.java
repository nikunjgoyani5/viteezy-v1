...
class HealthComplaintsAnswerControllerTest {
    ...
    private final HealthComplaintsAnswerService service = Mockito.mock(HealthComplaintsAnswerService.class);
    private HealthComplaintsAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new HealthComplaintsAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((HealthComplaintsAnswerGetResponse)response.getEntity()).getId());
