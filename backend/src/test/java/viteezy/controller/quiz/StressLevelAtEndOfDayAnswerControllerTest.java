...
class StressLevelAtEndOfDayAnswerControllerTest {
    ...
    private final StressLevelAtEndOfDayAnswerService service = Mockito.mock(StressLevelAtEndOfDayAnswerService.class);
    private StressLevelAtEndOfDayAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new StressLevelAtEndOfDayAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((StressLevelAtEndOfDayAnswerGetResponse)response.getEntity()).getId());
