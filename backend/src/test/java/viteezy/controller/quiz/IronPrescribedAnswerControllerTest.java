...
class IronPrescribedAnswerControllerTest {
    ...
    private final IronPrescribedAnswerService service = Mockito.mock(IronPrescribedAnswerService.class);
    private IronPrescribedAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new IronPrescribedAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((IronPrescribedAnswerGetResponse)response.getEntity()).getId());
