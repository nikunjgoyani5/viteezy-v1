...
class DailySixAlcoholicDrinksAnswerControllerTest {
    ...
    private final DailySixAlcoholicDrinksAnswerService service = Mockito.mock(DailySixAlcoholicDrinksAnswerService.class);
    private DailySixAlcoholicDrinksAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DailySixAlcoholicDrinksAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DailySixAlcoholicDrinksAnswerGetResponse)response.getEntity()).getId());
