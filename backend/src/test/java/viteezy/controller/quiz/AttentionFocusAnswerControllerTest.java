...
class AttentionFocusAnswerControllerTest {
    ...
    private final AttentionFocusAnswerService service = Mockito.mock(AttentionFocusAnswerService.class);
    private AttentionFocusAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AttentionFocusAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AttentionFocusAnswerGetResponse)response.getEntity()).getId());
