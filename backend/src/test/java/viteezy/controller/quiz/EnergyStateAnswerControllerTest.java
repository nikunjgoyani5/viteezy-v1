...
class EnergyStateAnswerControllerTest {
    ...
    private final EnergyStateAnswerService service = Mockito.mock(EnergyStateAnswerService.class);
    private EnergyStateAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new EnergyStateAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((EnergyStateAnswerGetResponse)response.getEntity()).getId());
