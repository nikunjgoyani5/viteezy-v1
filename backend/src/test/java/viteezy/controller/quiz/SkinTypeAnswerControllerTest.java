...
class SkinTypeAnswerControllerTest {
    ...
    private final SkinTypeAnswerService service = Mockito.mock(SkinTypeAnswerService.class);
    private SkinTypeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SkinTypeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SkinTypeAnswerGetResponse)response.getEntity()).getId());
