...
class SleepQualityAnswerControllerTest {
    ...
    private final SleepQualityAnswerService service = Mockito.mock(SleepQualityAnswerService.class);
    private SleepQualityAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SleepQualityAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SleepQualityAnswerGetResponse)response.getEntity()).getId());
