...
class MentalFitnessAnswerControllerTest {
    ...
    private final MentalFitnessAnswerService service = Mockito.mock(MentalFitnessAnswerService.class);
    private MentalFitnessAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new MentalFitnessAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((MentalFitnessAnswerGetResponse)response.getEntity()).getId());
