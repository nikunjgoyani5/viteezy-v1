...
class TiredWhenWakeUpAnswerControllerTest {
    ...
    private final TiredWhenWakeUpAnswerService service = Mockito.mock(TiredWhenWakeUpAnswerService.class);
    private TiredWhenWakeUpAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new TiredWhenWakeUpAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((TiredWhenWakeUpAnswerGetResponse)response.getEntity()).getId());
