...
class DrySkinAnswerControllerTest {
    ...
    private final DrySkinAnswerService service = Mockito.mock(DrySkinAnswerService.class);
    private DrySkinAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new DrySkinAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((DrySkinAnswerGetResponse)response.getEntity()).getId());
