...
class StressLevelAnswerControllerTest {
    ...
    private final StressLevelAnswerService service = Mockito.mock(StressLevelAnswerService.class);
    private StressLevelAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new StressLevelAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((StressLevelAnswerGetResponse)response.getEntity()).getId());
