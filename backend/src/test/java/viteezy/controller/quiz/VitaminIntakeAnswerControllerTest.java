...
class VitaminIntakeAnswerControllerTest {
    ...
    private final VitaminIntakeAnswerService service = Mockito.mock(VitaminIntakeAnswerService.class);
    private VitaminIntakeAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new VitaminIntakeAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((VitaminIntakeAnswerGetResponse)response.getEntity()).getId());
