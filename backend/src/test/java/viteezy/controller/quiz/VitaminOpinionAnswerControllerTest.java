...
class VitaminOpinionAnswerControllerTest {
    ...
    private final VitaminOpinionAnswerService service = Mockito.mock(VitaminOpinionAnswerService.class);
    private VitaminOpinionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new VitaminOpinionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((VitaminOpinionAnswerGetResponse)response.getEntity()).getId());
