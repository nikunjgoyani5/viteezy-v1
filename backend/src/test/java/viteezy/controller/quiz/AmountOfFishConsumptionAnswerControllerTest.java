...
class AmountOfFishConsumptionAnswerControllerTest {
    ...
    private final AmountOfFishConsumptionAnswerService service = Mockito.mock(AmountOfFishConsumptionAnswerService.class);
    private AmountOfFishConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfFishConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfFishConsumptionAnswerGetResponse)response.getEntity()).getId());
