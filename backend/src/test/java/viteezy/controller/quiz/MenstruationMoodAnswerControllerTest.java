...
class MenstruationMoodAnswerControllerTest {
    ...
    private final MenstruationMoodAnswerService service = Mockito.mock(MenstruationMoodAnswerService.class);
    private MenstruationMoodAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new MenstruationMoodAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((MenstruationMoodAnswerGetResponse)response.getEntity()).getId());
