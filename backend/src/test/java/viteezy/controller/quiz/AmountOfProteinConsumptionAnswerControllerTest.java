...
class AmountOfProteinConsumptionAnswerControllerTest {
    ...
    private final AmountOfProteinConsumptionAnswerService service = Mockito.mock(AmountOfProteinConsumptionAnswerService.class);
    private AmountOfProteinConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfProteinConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfProteinConsumptionAnswerGetResponse)response.getEntity()).getId());
