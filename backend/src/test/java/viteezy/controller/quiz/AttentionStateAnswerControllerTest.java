...
class AttentionStateAnswerControllerTest {
    ...
    private final AttentionStateAnswerService service = Mockito.mock(AttentionStateAnswerService.class);
    private AttentionStateAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AttentionStateAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AttentionStateAnswerGetResponse)response.getEntity()).getId());
