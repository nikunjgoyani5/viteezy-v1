...
class LibidoStressLevelAnswerControllerTest {
    ...
    private final LibidoStressLevelAnswerService service = Mockito.mock(LibidoStressLevelAnswerService.class);
    private LibidoStressLevelAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new LibidoStressLevelAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((LibidoStressLevelAnswerGetResponse)response.getEntity()).getId());
