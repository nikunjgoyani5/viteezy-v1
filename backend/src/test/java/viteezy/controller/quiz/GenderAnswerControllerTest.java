...
class GenderAnswerControllerTest {
    ...
    private final GenderAnswerService service = Mockito.mock(GenderAnswerService.class);
    private GenderAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new GenderAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((GenderAnswerGetResponse)response.getEntity()).getId());
