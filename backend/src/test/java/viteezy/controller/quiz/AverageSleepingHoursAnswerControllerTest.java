...
class AverageSleepingHoursAnswerControllerTest {
    ...
    private final AverageSleepingHoursAnswerService service = Mockito.mock(AverageSleepingHoursAnswerService.class);
    private AverageSleepingHoursAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AverageSleepingHoursAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AverageSleepingHoursAnswerGetResponse)response.getEntity()).getId());
