...
class HealthyLifestyleAnswerControllerTest {
    ...
    private final HealthyLifestyleAnswerService service = Mockito.mock(HealthyLifestyleAnswerService.class);
    private HealthyLifestyleAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new HealthyLifestyleAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((HealthyLifestyleAnswerGetResponse)response.getEntity()).getId());
