...
class SportReasonAnswerControllerTest {
    ...
    private final SportReasonAnswerService service = Mockito.mock(SportReasonAnswerService.class);
    private SportReasonAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new SportReasonAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((SportReasonAnswerGetResponse)response.getEntity()).getId());
