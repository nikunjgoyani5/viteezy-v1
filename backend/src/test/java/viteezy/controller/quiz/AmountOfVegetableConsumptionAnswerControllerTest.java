...
class AmountOfVegetableConsumptionAnswerControllerTest {
    ...
    private final AmountOfVegetableConsumptionAnswerService service = Mockito.mock(AmountOfVegetableConsumptionAnswerService.class);
    private AmountOfVegetableConsumptionAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new AmountOfVegetableConsumptionAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((AmountOfVegetableConsumptionAnswerGetResponse)response.getEntity()).getId());
