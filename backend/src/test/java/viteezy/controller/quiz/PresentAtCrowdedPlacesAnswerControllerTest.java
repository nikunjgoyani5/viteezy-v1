...
class PresentAtCrowdedPlacesAnswerControllerTest {
    ...
    private final PresentAtCrowdedPlacesAnswerService service = Mockito.mock(PresentAtCrowdedPlacesAnswerService.class);
    private PresentAtCrowdedPlacesAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new PresentAtCrowdedPlacesAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((PresentAtCrowdedPlacesAnswerGetResponse)response.getEntity()).getId());
