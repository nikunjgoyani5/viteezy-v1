...
class NailImprovementAnswerControllerTest {
    ...
    private final NailImprovementAnswerService service = Mockito.mock(NailImprovementAnswerService.class);
    private NailImprovementAnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new NailImprovementAnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((NailImprovementAnswerGetResponse)response.getEntity()).getId());
