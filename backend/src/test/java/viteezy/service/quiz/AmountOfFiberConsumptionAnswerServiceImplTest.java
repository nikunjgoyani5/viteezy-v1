...
class AmountOfFiberConsumptionAnswerServiceImplTest {
    ...
    private static final AmountOfFiberConsumptionAnswer SAMPLE_ENTITY = new AmountOfFiberConsumptionAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final AmountOfFiberConsumptionAnswerRepository repository = Mockito.mock(AmountOfFiberConsumptionAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private AmountOfFiberConsumptionAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfFiberConsumptionAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfFiberConsumptionAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<AmountOfFiberConsumptionAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfFiberConsumptionAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, AmountOfFiberConsumptionAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
