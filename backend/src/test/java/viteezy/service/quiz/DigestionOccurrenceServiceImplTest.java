...
class DigestionOccurrenceServiceImplTest {
    ...
    private final DigestionOccurrenceRepository repository = Mockito.mock(DigestionOccurrenceRepository.class);
    private DigestionOccurrenceServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DigestionOccurrenceServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DigestionOccurrence>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DigestionOccurrence>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DigestionOccurrence> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
