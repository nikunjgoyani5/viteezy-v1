...
class DigestionAmountServiceImplTest {
    ...
    private final DigestionAmountRepository repository = Mockito.mock(DigestionAmountRepository.class);
    private DigestionAmountServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DigestionAmountServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DigestionAmount>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DigestionAmount>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DigestionAmount> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
