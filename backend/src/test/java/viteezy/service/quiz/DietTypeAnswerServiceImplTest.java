...
class DietTypeAnswerServiceImplTest {
    ...
    private static final DietTypeAnswer SAMPLE_ENTITY = new DietTypeAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final DietTypeAnswerRepository repository = Mockito.mock(DietTypeAnswerRepository.class);
    private final QuizRepository quizRepository = Mockito.mock(QuizRepository.class);
    private DietTypeAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DietTypeAnswerServiceImpl(repository, quizRepository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DietTypeAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<DietTypeAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, DietTypeAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, DietTypeAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
