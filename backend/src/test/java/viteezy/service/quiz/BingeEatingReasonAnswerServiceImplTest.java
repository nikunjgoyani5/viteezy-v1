...
class BingeEatingReasonAnswerServiceImplTest {
    ...
    private static final BingeEatingReasonAnswer SAMPLE_ENTITY = new BingeEatingReasonAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final BingeEatingReasonAnswerRepository repository = Mockito.mock(BingeEatingReasonAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private BingeEatingReasonAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new BingeEatingReasonAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<BingeEatingReasonAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<BingeEatingReasonAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, BingeEatingReasonAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, BingeEatingReasonAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
