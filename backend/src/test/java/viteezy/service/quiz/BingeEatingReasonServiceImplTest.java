...
class BingeEatingReasonServiceImplTest {
    ...
    private final BingeEatingReasonRepository repository = Mockito.mock(BingeEatingReasonRepository.class);
    private BingeEatingReasonServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new BingeEatingReasonServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<BingeEatingReason>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<BingeEatingReason>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, BingeEatingReason> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
