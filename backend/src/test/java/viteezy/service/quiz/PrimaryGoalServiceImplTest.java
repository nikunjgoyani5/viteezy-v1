...
class PrimaryGoalServiceImplTest {
    ...
    private final PrimaryGoalRepository repository = Mockito.mock(PrimaryGoalRepository.class);
    private PrimaryGoalServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new PrimaryGoalServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<PrimaryGoal>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<PrimaryGoal>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, PrimaryGoal> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
