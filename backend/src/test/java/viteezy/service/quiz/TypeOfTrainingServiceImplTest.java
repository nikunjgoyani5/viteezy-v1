...
class TypeOfTrainingServiceImplTest {
    ...
    private static final TypeOfTraining SAMPLE_ENTITY = new TypeOfTraining(ID, NAME, CODE, true, SUBTITLE, LocalDateTime.now(), LocalDateTime.now());

    private final TypeOfTrainingRepository repository = Mockito.mock(TypeOfTrainingRepository.class);
    private TypeOfTrainingServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TypeOfTrainingServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TypeOfTraining>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<TypeOfTraining>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, TypeOfTraining> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
