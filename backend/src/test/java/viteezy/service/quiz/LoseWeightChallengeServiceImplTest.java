...
class LoseWeightChallengeServiceImplTest {
    ...
    private final LoseWeightChallengeRepository repository = Mockito.mock(LoseWeightChallengeRepository.class);
    private LoseWeightChallengeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new LoseWeightChallengeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<LoseWeightChallenge>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<LoseWeightChallenge>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, LoseWeightChallenge> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
