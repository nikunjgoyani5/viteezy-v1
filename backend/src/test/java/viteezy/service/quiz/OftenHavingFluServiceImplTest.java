...
class OftenHavingFluServiceImplTest {
    ...
    private final OftenHavingFluRepository repository = Mockito.mock(OftenHavingFluRepository.class);
    private OftenHavingFluServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new OftenHavingFluServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<OftenHavingFlu>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<OftenHavingFlu>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, OftenHavingFlu> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
