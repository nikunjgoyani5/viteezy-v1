...
class MenstruationIntervalAnswerServiceImplTest {
    ...
    private static final MenstruationIntervalAnswer SAMPLE_ENTITY = new MenstruationIntervalAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final MenstruationIntervalAnswerRepository repository = Mockito.mock(MenstruationIntervalAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private MenstruationIntervalAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MenstruationIntervalAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MenstruationIntervalAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<MenstruationIntervalAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, MenstruationIntervalAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, MenstruationIntervalAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
