...
class CurrentLibidoServiceImplTest {
    ...
    private final CurrentLibidoRepository repository = Mockito.mock(CurrentLibidoRepository.class);
    private CurrentLibidoServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new CurrentLibidoServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<CurrentLibido>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<CurrentLibido>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, CurrentLibido> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
