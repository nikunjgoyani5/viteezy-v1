...
class DietIntoleranceServiceImplTest {
    ...
    private final DietIntoleranceRepository repository = Mockito.mock(DietIntoleranceRepository.class);
    private DietIntoleranceServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DietIntoleranceServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DietIntolerance>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DietIntolerance>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DietIntolerance> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
