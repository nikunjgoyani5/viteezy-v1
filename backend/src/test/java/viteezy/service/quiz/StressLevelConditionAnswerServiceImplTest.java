...
class StressLevelConditionAnswerServiceImplTest {
    ...
    private static final StressLevelConditionAnswer SAMPLE_ENTITY = new StressLevelConditionAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final StressLevelConditionAnswerRepository repository = Mockito.mock(StressLevelConditionAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private StressLevelConditionAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new StressLevelConditionAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<StressLevelConditionAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<StressLevelConditionAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, StressLevelConditionAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, StressLevelConditionAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
