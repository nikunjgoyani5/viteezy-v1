...
class TrainingIntensivelyServiceImplTest {
    ...
    private final TrainingIntensivelyRepository repository = Mockito.mock(TrainingIntensivelyRepository.class);
    private TrainingIntensivelyServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TrainingIntensivelyServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TrainingIntensively>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<TrainingIntensively>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, TrainingIntensively> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
