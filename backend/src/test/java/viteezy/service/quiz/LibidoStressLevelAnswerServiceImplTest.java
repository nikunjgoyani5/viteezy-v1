...
class LibidoStressLevelAnswerServiceImplTest {
    ...
    private static final LibidoStressLevelAnswer SAMPLE_ENTITY = new LibidoStressLevelAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final LibidoStressLevelAnswerRepository repository = Mockito.mock(LibidoStressLevelAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private LibidoStressLevelAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new LibidoStressLevelAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<LibidoStressLevelAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<LibidoStressLevelAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, LibidoStressLevelAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, LibidoStressLevelAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
