...
class TiredWhenWakeUpAnswerServiceImplTest {
    ...
    private static final TiredWhenWakeUpAnswer SAMPLE_ENTITY = new TiredWhenWakeUpAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final TiredWhenWakeUpAnswerRepository repository = Mockito.mock(TiredWhenWakeUpAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private TiredWhenWakeUpAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TiredWhenWakeUpAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TiredWhenWakeUpAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<TiredWhenWakeUpAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, TiredWhenWakeUpAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, TiredWhenWakeUpAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
