...
class MenstruationMoodAnswerServiceImplTest {
    ...
    private static final MenstruationMoodAnswer SAMPLE_ENTITY = new MenstruationMoodAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final MenstruationMoodAnswerRepository repository = Mockito.mock(MenstruationMoodAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private MenstruationMoodAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MenstruationMoodAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MenstruationMoodAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<MenstruationMoodAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, MenstruationMoodAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, MenstruationMoodAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
