...
class DietTypeServiceImplTest {
    ...
    private final DietTypeRepository repository = Mockito.mock(DietTypeRepository.class);
    private DietTypeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DietTypeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DietType>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DietType>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DietType> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
