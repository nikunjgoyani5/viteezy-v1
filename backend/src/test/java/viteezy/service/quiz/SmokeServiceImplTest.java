...
class SmokeServiceImplTest {
    ...
    private final SmokeRepository repository = Mockito.mock(SmokeRepository.class);
    private SmokeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SmokeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<Smoke>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<Smoke>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, Smoke> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
