...
class SkinTypeServiceImplTest {
    ...
    private final SkinTypeRepository repository = Mockito.mock(SkinTypeRepository.class);
    private SkinTypeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SkinTypeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SkinType>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<SkinType>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, SkinType> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
