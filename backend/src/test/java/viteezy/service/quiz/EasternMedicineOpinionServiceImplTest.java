...
class EasternMedicineOpinionServiceImplTest {
    ...
    private final EasternMedicineOpinionRepository repository = Mockito.mock(EasternMedicineOpinionRepository.class);
    private EasternMedicineOpinionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new EasternMedicineOpinionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<EasternMedicineOpinion>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<EasternMedicineOpinion>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, EasternMedicineOpinion> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
