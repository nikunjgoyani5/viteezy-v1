...
class LackOfConcentrationAnswerServiceImplTest {
    ...
    private static final LackOfConcentrationAnswer SAMPLE_ENTITY = new LackOfConcentrationAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final LackOfConcentrationAnswerRepository repository = Mockito.mock(LackOfConcentrationAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private LackOfConcentrationAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new LackOfConcentrationAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<LackOfConcentrationAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<LackOfConcentrationAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, LackOfConcentrationAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, LackOfConcentrationAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
