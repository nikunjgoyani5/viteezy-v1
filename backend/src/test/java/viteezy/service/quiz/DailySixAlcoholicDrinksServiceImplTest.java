...
class DailySixAlcoholicDrinksServiceImplTest {
    ...
    private final DailySixAlcoholicDrinksRepository repository = Mockito.mock(DailySixAlcoholicDrinksRepository.class);
    private DailySixAlcoholicDrinksServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DailySixAlcoholicDrinksServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DailySixAlcoholicDrinks>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DailySixAlcoholicDrinks>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DailySixAlcoholicDrinks> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
