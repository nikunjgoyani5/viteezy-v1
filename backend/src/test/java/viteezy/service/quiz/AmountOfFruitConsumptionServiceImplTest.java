...
class AmountOfFruitConsumptionServiceImplTest {
    ...
    private final AmountOfFruitConsumptionRepository repository = Mockito.mock(AmountOfFruitConsumptionRepository.class);
    private AmountOfFruitConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfFruitConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfFruitConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfFruitConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfFruitConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
