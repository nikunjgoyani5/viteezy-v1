...
class MentalFitnessServiceImplTest {
    ...
    private final MentalFitnessRepository repository = Mockito.mock(MentalFitnessRepository.class);
    private MentalFitnessServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MentalFitnessServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MentalFitness>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<MentalFitness>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, MentalFitness> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
