...
class TypeOfTrainingAnswerServiceImplTest {
    ...
    private static final TypeOfTrainingAnswer SAMPLE_ENTITY = new TypeOfTrainingAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final TypeOfTrainingAnswerRepository repository = Mockito.mock(TypeOfTrainingAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private TypeOfTrainingAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TypeOfTrainingAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TypeOfTrainingAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<TypeOfTrainingAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, TypeOfTrainingAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, TypeOfTrainingAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
