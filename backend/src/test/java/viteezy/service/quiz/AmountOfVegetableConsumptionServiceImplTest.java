...
class AmountOfVegetableConsumptionServiceImplTest {
    ...
    private final AmountOfVegetableConsumptionRepository repository = Mockito.mock(AmountOfVegetableConsumptionRepository.class);
    private AmountOfVegetableConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfVegetableConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfVegetableConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfVegetableConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfVegetableConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
