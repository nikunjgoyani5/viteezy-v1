...
class LackOfConcentrationServiceImplTest {
    ...
    private final LackOfConcentrationRepository repository = Mockito.mock(LackOfConcentrationRepository.class);
    private LackOfConcentrationServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new LackOfConcentrationServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<LackOfConcentration>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<LackOfConcentration>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, LackOfConcentration> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
