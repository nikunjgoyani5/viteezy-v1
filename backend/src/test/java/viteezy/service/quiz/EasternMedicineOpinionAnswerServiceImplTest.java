...
class EasternMedicineOpinionAnswerServiceImplTest {
    ...
    private static final EasternMedicineOpinionAnswer SAMPLE_ENTITY = new EasternMedicineOpinionAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final EasternMedicineOpinionAnswerRepository repository = Mockito.mock(EasternMedicineOpinionAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private EasternMedicineOpinionAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new EasternMedicineOpinionAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<EasternMedicineOpinionAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<EasternMedicineOpinionAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, EasternMedicineOpinionAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, EasternMedicineOpinionAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
