...
class AmountOfDairyConsumptionServiceImplTest {
    ...
    private final AmountOfDairyConsumptionRepository repository = Mockito.mock(AmountOfDairyConsumptionRepository.class);
    private AmountOfDairyConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfDairyConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfDairyConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfDairyConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfDairyConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
