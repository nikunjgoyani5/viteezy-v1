...
class AmountOfProteinConsumptionServiceImplTest {
    ...
    private final AmountOfProteinConsumptionRepository repository = Mockito.mock(AmountOfProteinConsumptionRepository.class);
    private AmountOfProteinConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfProteinConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfProteinConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfProteinConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfProteinConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
