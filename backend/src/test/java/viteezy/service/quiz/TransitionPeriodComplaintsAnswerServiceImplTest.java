...
class TransitionPeriodComplaintsAnswerServiceImplTest {
    ...
    private static final TransitionPeriodComplaintsAnswer SAMPLE_ENTITY = new TransitionPeriodComplaintsAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final TransitionPeriodComplaintsAnswerRepository repository = Mockito.mock(TransitionPeriodComplaintsAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private TransitionPeriodComplaintsAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TransitionPeriodComplaintsAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TransitionPeriodComplaintsAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<TransitionPeriodComplaintsAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, TransitionPeriodComplaintsAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, TransitionPeriodComplaintsAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
