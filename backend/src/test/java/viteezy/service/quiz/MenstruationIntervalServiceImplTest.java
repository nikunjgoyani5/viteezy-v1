...
class MenstruationIntervalServiceImplTest {
    ...
    private final MenstruationIntervalRepository repository = Mockito.mock(MenstruationIntervalRepository.class);
    private MenstruationIntervalServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MenstruationIntervalServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MenstruationInterval>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<MenstruationInterval>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, MenstruationInterval> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
