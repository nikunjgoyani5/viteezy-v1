...
class AcnePlaceServiceImplTest {
    ...
    private final AcnePlaceRepository repository = Mockito.mock(AcnePlaceRepository.class);
    private AcnePlaceServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AcnePlaceServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AcnePlace>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AcnePlace>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AcnePlace> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
