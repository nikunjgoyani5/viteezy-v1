...
class MenstruationSideIssueServiceImplTest {
    ...
    private final MenstruationSideIssueRepository repository = Mockito.mock(MenstruationSideIssueRepository.class);
    private MenstruationSideIssueServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MenstruationSideIssueServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MenstruationSideIssue>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<MenstruationSideIssue>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, MenstruationSideIssue> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
