...
class PregnancyStateServiceImplTest {
    ...
    private final PregnancyStateRepository repository = Mockito.mock(PregnancyStateRepository.class);
    private PregnancyStateServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new PregnancyStateServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<PregnancyState>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<PregnancyState>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, PregnancyState> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
