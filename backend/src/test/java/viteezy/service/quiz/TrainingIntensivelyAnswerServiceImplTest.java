...
class TrainingIntensivelyAnswerServiceImplTest {
    ...
    private static final TrainingIntensivelyAnswer SAMPLE_ENTITY = new TrainingIntensivelyAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final TrainingIntensivelyAnswerRepository repository = Mockito.mock(TrainingIntensivelyAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private TrainingIntensivelyAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TrainingIntensivelyAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TrainingIntensivelyAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<TrainingIntensivelyAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, TrainingIntensivelyAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, TrainingIntensivelyAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
