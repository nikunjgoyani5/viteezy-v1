...
class HelpGoalServiceImplTest {
    ...
    private final HelpGoalRepository repository = Mockito.mock(HelpGoalRepository.class);
    private HelpGoalServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new HelpGoalServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<HelpGoal>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<HelpGoal>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, HelpGoal> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
