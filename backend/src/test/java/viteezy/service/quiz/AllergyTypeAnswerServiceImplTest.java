...
class AllergyTypeAnswerServiceImplTest {
    ...
    private final AllergyTypeAnswerRepository repository = Mockito.mock(AllergyTypeAnswerRepository.class);
    private final QuizRepository quizRepository = Mockito.mock(QuizRepository.class);
    private AllergyTypeAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AllergyTypeAnswerServiceImpl(repository, quizRepository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AllergyTypeAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, List<AllergyTypeAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AllergyTypeAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
