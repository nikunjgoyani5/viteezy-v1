...
class AllergyTypeServiceImplTest {
    ...
    private final AllergyTypeRepository repository = Mockito.mock(AllergyTypeRepository.class);
    private AllergyTypeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AllergyTypeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AllergyType>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AllergyType>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AllergyType> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
