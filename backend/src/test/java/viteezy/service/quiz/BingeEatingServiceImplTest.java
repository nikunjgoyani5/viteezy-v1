...
class BingeEatingServiceImplTest {

    private static final Long ID = 1L;
    private static final String NAME = "NAME";
    private static final String CODE = "123";
    private static final CloseException EXCEPTION = new CloseException("EXCEPTION", new Throwable());
    private static final BingeEating SAMPLE_ENTITY = new BingeEating(ID, NAME, CODE, true, LocalDateTime.now(), LocalDateTime.now());

    private final BingeEatingRepository repository = Mockito.mock(BingeEatingRepository.class);
    private BingeEatingServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new BingeEatingServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<BingeEating>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<BingeEating>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, BingeEating> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
