...
class UsageGoalServiceImplTest {
    ...
    private final UsageGoalRepository repository = Mockito.mock(UsageGoalRepository.class);
    private UsageGoalServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new UsageGoalServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<UsageGoal>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<UsageGoal>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, UsageGoal> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
