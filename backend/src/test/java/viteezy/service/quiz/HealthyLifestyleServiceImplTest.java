...
class HealthyLifestyleServiceImplTest {
    ...
    private final HealthyLifestyleRepository repository = Mockito.mock(HealthyLifestyleRepository.class);
    private HealthyLifestyleServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new HealthyLifestyleServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<HealthyLifestyle>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<HealthyLifestyle>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, HealthyLifestyle> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
