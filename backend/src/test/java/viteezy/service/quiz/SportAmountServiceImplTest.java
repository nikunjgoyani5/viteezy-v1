...
class SportAmountServiceImplTest {
    ...
    private final SportAmountRepository repository = Mockito.mock(SportAmountRepository.class);
    private SportAmountServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SportAmountServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SportAmount>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<SportAmount>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, SportAmount> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
