...
class StressLevelAtEndOfDayAnswerServiceImplTest {
    ...
    private static final StressLevelAtEndOfDayAnswer SAMPLE_ENTITY = new StressLevelAtEndOfDayAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final StressLevelAtEndOfDayAnswerRepository repository = Mockito.mock(StressLevelAtEndOfDayAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private StressLevelAtEndOfDayAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new StressLevelAtEndOfDayAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<StressLevelAtEndOfDayAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<StressLevelAtEndOfDayAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, StressLevelAtEndOfDayAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, StressLevelAtEndOfDayAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
