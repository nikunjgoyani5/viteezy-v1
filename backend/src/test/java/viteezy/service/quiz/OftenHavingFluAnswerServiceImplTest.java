...
class OftenHavingFluAnswerServiceImplTest {
    ...
    private static final OftenHavingFluAnswer SAMPLE_ENTITY = new OftenHavingFluAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final OftenHavingFluAnswerRepository repository = Mockito.mock(OftenHavingFluAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private OftenHavingFluAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new OftenHavingFluAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<OftenHavingFluAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<OftenHavingFluAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, OftenHavingFluAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, OftenHavingFluAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
