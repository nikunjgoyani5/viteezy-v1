...
class DailyFourCoffeeServiceImplTest {
    ...
    private final DailyFourCoffeeRepository repository = Mockito.mock(DailyFourCoffeeRepository.class);
    private DailyFourCoffeeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DailyFourCoffeeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DailyFourCoffee>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DailyFourCoffee>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DailyFourCoffee> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
