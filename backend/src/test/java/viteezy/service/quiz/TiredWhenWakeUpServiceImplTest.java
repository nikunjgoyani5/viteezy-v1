...
class TiredWhenWakeUpServiceImplTest {
    ...
    private final TiredWhenWakeUpRepository repository = Mockito.mock(TiredWhenWakeUpRepository.class);
    private TiredWhenWakeUpServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TiredWhenWakeUpServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TiredWhenWakeUp>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<TiredWhenWakeUp>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, TiredWhenWakeUp> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
