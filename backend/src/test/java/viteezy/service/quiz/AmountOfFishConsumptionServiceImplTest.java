...
class AmountOfFishConsumptionServiceImplTest {
    ...
    private final AmountOfFishConsumptionRepository repository = Mockito.mock(AmountOfFishConsumptionRepository.class);
    private AmountOfFishConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfFishConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfFishConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfFishConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfFishConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
