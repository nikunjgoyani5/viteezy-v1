...
class AmountOfProteinConsumptionAnswerServiceImplTest {
    ...
    private static final AmountOfProteinConsumptionAnswer SAMPLE_ENTITY = new AmountOfProteinConsumptionAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final AmountOfProteinConsumptionAnswerRepository repository = Mockito.mock(AmountOfProteinConsumptionAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private AmountOfProteinConsumptionAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfProteinConsumptionAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfProteinConsumptionAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<AmountOfProteinConsumptionAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfProteinConsumptionAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, AmountOfProteinConsumptionAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
