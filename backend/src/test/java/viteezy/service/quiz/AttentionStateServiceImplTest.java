...
class AttentionStateServiceImplTest {
    ...
    private final AttentionStateRepository repository = Mockito.mock(AttentionStateRepository.class);
    private AttentionStateServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AttentionStateServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AttentionState>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AttentionState>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AttentionState> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
