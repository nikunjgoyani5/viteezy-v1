...
class NailImprovementServiceImplTest {
    ...
    private final NailImprovementRepository repository = Mockito.mock(NailImprovementRepository.class);
    private NailImprovementServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new NailImprovementServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<NailImprovement>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<NailImprovement>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, NailImprovement> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
