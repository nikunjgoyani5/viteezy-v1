...
class ThirtyMinutesOfSunAnswerServiceImplTest {
    ...
    private static final ThirtyMinutesOfSunAnswer SAMPLE_ENTITY = new ThirtyMinutesOfSunAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final ThirtyMinutesOfSunAnswerRepository repository = Mockito.mock(ThirtyMinutesOfSunAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private ThirtyMinutesOfSunAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new ThirtyMinutesOfSunAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<ThirtyMinutesOfSunAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<ThirtyMinutesOfSunAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, ThirtyMinutesOfSunAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, ThirtyMinutesOfSunAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
