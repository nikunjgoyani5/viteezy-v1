...
class SportReasonServiceImplTest {
    ...
    private final SportReasonRepository repository = Mockito.mock(SportReasonRepository.class);
    private SportReasonServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SportReasonServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SportReason>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<SportReason>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, SportReason> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
