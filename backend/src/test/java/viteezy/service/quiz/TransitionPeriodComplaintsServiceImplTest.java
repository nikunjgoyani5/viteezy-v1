...
class TransitionPeriodComplaintsServiceImplTest {
    ...
    private final TransitionPeriodComplaintsRepository repository = Mockito.mock(TransitionPeriodComplaintsRepository.class);
    private TransitionPeriodComplaintsServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TransitionPeriodComplaintsServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TransitionPeriodComplaints>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<TransitionPeriodComplaints>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, TransitionPeriodComplaints> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
