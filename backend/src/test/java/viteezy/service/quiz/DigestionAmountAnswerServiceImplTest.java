...
class DigestionAmountAnswerServiceImplTest {
    ...
    private static final DigestionAmountAnswer SAMPLE_ENTITY = new DigestionAmountAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final DigestionAmountAnswerRepository repository = Mockito.mock(DigestionAmountAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private DigestionAmountAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DigestionAmountAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DigestionAmountAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<DigestionAmountAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, DigestionAmountAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, DigestionAmountAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
