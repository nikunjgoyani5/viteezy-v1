...
class AttentionFocusAnswerServiceImplTest {
    ...
    private static final AttentionFocusAnswer SAMPLE_ENTITY = new AttentionFocusAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final AttentionFocusAnswerRepository repository = Mockito.mock(AttentionFocusAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private AttentionFocusAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AttentionFocusAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AttentionFocusAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<AttentionFocusAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, AttentionFocusAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, AttentionFocusAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
