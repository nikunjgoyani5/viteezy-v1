...
class IronPrescribedAnswerServiceImplTest {
    ...
    private static final IronPrescribedAnswer SAMPLE_ENTITY = new IronPrescribedAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final IronPrescribedAnswerRepository repository = Mockito.mock(IronPrescribedAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private IronPrescribedAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new IronPrescribedAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<IronPrescribedAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<IronPrescribedAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, IronPrescribedAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, IronPrescribedAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
