...
class VitaminIntakeServiceImplTest {
    ...
    private final VitaminIntakeRepository repository = Mockito.mock(VitaminIntakeRepository.class);
    private VitaminIntakeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new VitaminIntakeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<VitaminIntake>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<VitaminIntake>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, VitaminIntake> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
