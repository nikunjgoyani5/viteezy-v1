...
class NewProductAvailableServiceImplTest {
    ...
    private final NewProductAvailableRepository repository = Mockito.mock(NewProductAvailableRepository.class);
    private NewProductAvailableServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new NewProductAvailableServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<NewProductAvailable>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<NewProductAvailable>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, NewProductAvailable> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
