...
class ThirtyMinutesOfSunServiceImplTest {
    ...
    private final ThirtyMinutesOfSunRepository repository = Mockito.mock(ThirtyMinutesOfSunRepository.class);
    private ThirtyMinutesOfSunServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new ThirtyMinutesOfSunServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<ThirtyMinutesOfSun>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<ThirtyMinutesOfSun>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, ThirtyMinutesOfSun> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
