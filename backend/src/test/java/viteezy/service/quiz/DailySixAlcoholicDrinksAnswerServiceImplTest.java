...
class DailySixAlcoholicDrinksAnswerServiceImplTest {
    ...
    private static final DailySixAlcoholicDrinksAnswer SAMPLE_ENTITY = new DailySixAlcoholicDrinksAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final DailySixAlcoholicDrinksAnswerRepository repository = Mockito.mock(DailySixAlcoholicDrinksAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private DailySixAlcoholicDrinksAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DailySixAlcoholicDrinksAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DailySixAlcoholicDrinksAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<DailySixAlcoholicDrinksAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, DailySixAlcoholicDrinksAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, DailySixAlcoholicDrinksAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
