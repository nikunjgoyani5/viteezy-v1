...
class HealthComplaintsServiceImplTest {
    ...
    private final HealthComplaintsRepository repository = Mockito.mock(HealthComplaintsRepository.class);
    private HealthComplaintsServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new HealthComplaintsServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<HealthComplaints>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<HealthComplaints>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, HealthComplaints> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
