...
class SleepHoursLessThanSevenAnswerServiceImplTest {
    ...
    private static final SleepHoursLessThanSevenAnswer SAMPLE_ENTITY = new SleepHoursLessThanSevenAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final SleepHoursLessThanSevenAnswerRepository repository = Mockito.mock(SleepHoursLessThanSevenAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private SleepHoursLessThanSevenAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SleepHoursLessThanSevenAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SleepHoursLessThanSevenAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<SleepHoursLessThanSevenAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, SleepHoursLessThanSevenAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, SleepHoursLessThanSevenAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
