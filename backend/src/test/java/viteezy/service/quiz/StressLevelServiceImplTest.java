...
class StressLevelServiceImplTest {
    ...
    private final StressLevelRepository repository = Mockito.mock(StressLevelRepository.class);
    private StressLevelServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new StressLevelServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<StressLevel>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<StressLevel>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, StressLevel> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
