...
class SleepHoursLessThanSevenServiceImplTest {
    ...
    private final SleepHoursLessThanSevenRepository repository = Mockito.mock(SleepHoursLessThanSevenRepository.class);
    private SleepHoursLessThanSevenServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SleepHoursLessThanSevenServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SleepHoursLessThanSeven>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<SleepHoursLessThanSeven>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, SleepHoursLessThanSeven> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
