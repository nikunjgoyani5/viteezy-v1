...
class NailImprovementAnswerServiceImplTest {
    ...
    private static final NailImprovementAnswer SAMPLE_ENTITY = new NailImprovementAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final NailImprovementAnswerRepository repository = Mockito.mock(NailImprovementAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private NailImprovementAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new NailImprovementAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<NailImprovementAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<NailImprovementAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, NailImprovementAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, NailImprovementAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
