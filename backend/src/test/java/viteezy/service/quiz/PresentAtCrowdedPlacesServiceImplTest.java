...
class PresentAtCrowdedPlacesServiceImplTest {
    ...
    private final PresentAtCrowdedPlacesRepository repository = Mockito.mock(PresentAtCrowdedPlacesRepository.class);
    private PresentAtCrowdedPlacesServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new PresentAtCrowdedPlacesServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<PresentAtCrowdedPlaces>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<PresentAtCrowdedPlaces>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, PresentAtCrowdedPlaces> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
