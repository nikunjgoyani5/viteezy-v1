...
class AmountOfVegetableConsumptionAnswerServiceImplTest {
    ...
    private static final AmountOfVegetableConsumptionAnswer SAMPLE_ENTITY = new AmountOfVegetableConsumptionAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final AmountOfVegetableConsumptionAnswerRepository repository = Mockito.mock(AmountOfVegetableConsumptionAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private AmountOfVegetableConsumptionAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfVegetableConsumptionAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfVegetableConsumptionAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<AmountOfVegetableConsumptionAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfVegetableConsumptionAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, AmountOfVegetableConsumptionAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
