...
class AttentionFocusServiceImplTest {
    ...
    private final AttentionFocusRepository repository = Mockito.mock(AttentionFocusRepository.class);
    private AttentionFocusServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AttentionFocusServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AttentionFocus>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AttentionFocus>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AttentionFocus> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
