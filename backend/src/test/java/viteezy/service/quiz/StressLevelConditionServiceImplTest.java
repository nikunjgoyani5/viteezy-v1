...
class StressLevelConditionServiceImplTest {
    ...
    private final StressLevelConditionRepository repository = Mockito.mock(StressLevelConditionRepository.class);
    private StressLevelConditionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new StressLevelConditionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<StressLevelCondition>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<StressLevelCondition>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, StressLevelCondition> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
