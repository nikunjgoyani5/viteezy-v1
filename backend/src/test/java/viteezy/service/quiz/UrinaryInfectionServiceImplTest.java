...
class UrinaryInfectionServiceImplTest {
    ...
    private final UrinaryInfectionRepository repository = Mockito.mock(UrinaryInfectionRepository.class);
    private UrinaryInfectionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new UrinaryInfectionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<UrinaryInfection>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<UrinaryInfection>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, UrinaryInfection> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
