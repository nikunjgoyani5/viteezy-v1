...
class AverageSleepingHoursServiceImplTest {
    ...
    private final AverageSleepingHoursRepository repository = Mockito.mock(AverageSleepingHoursRepository.class);
    private AverageSleepingHoursServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AverageSleepingHoursServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AverageSleepingHours>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AverageSleepingHours>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AverageSleepingHours> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
