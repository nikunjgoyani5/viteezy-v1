...
class EnergyStateServiceImplTest {
    ...
    private final EnergyStateRepository repository = Mockito.mock(EnergyStateRepository.class);
    private EnergyStateServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new EnergyStateServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<EnergyState>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<EnergyState>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, EnergyState> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
