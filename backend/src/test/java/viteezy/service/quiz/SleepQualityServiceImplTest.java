...
class SleepQualityServiceImplTest {
    ...
    private final SleepQualityRepository repository = Mockito.mock(SleepQualityRepository.class);
    private SleepQualityServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new SleepQualityServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<SleepQuality>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<SleepQuality>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, SleepQuality> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
