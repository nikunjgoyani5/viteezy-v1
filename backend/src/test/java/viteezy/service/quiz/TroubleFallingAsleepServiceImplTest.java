...
class TroubleFallingAsleepServiceImplTest {
    ...
    private final TroubleFallingAsleepRepository repository = Mockito.mock(TroubleFallingAsleepRepository.class);
    private TroubleFallingAsleepServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new TroubleFallingAsleepServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<TroubleFallingAsleep>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<TroubleFallingAsleep>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, TroubleFallingAsleep> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
