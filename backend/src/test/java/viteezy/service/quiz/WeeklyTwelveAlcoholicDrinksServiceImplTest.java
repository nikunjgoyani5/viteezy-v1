...
class WeeklyTwelveAlcoholicDrinksServiceImplTest {
    ...
    private final WeeklyTwelveAlcoholicDrinksRepository repository = Mockito.mock(WeeklyTwelveAlcoholicDrinksRepository.class);
    private WeeklyTwelveAlcoholicDrinksServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new WeeklyTwelveAlcoholicDrinksServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<WeeklyTwelveAlcoholicDrinks>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<WeeklyTwelveAlcoholicDrinks>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, WeeklyTwelveAlcoholicDrinks> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
