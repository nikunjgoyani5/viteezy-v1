...
class StressLevelAtEndOfDayServiceImplTest {
    ...
    private final StressLevelAtEndOfDayRepository repository = Mockito.mock(StressLevelAtEndOfDayRepository.class);
    private StressLevelAtEndOfDayServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new StressLevelAtEndOfDayServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<StressLevelAtEndOfDay>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<StressLevelAtEndOfDay>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, StressLevelAtEndOfDay> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
