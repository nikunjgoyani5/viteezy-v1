...
class HairTypeServiceImplTest {
    ...
    private final HairTypeRepository repository = Mockito.mock(HairTypeRepository.class);
    private HairTypeServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new HairTypeServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<HairType>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<HairType>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, HairType> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
