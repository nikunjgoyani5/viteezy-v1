...
class DietIntoleranceAnswerServiceImplTest {
    ...
    private final DietIntoleranceAnswerRepository repository = Mockito.mock(DietIntoleranceAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private DietIntoleranceAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DietIntoleranceAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DietIntoleranceAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, List<DietIntoleranceAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DietIntoleranceAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
