...
class AmountOfFiberConsumptionServiceImplTest {
    ...
    private final AmountOfFiberConsumptionRepository repository = Mockito.mock(AmountOfFiberConsumptionRepository.class);
    private AmountOfFiberConsumptionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AmountOfFiberConsumptionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AmountOfFiberConsumption>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<AmountOfFiberConsumption>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, AmountOfFiberConsumption> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
