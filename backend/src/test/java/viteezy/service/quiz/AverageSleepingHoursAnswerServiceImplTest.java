...
class AverageSleepingHoursAnswerServiceImplTest {
    ...
    private static final AverageSleepingHoursAnswer SAMPLE_ENTITY = new AverageSleepingHoursAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final AverageSleepingHoursAnswerRepository repository = Mockito.mock(AverageSleepingHoursAnswerRepository.class);
    private final QuizService quizService = Mockito.mock(QuizService.class);
    private AverageSleepingHoursAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new AverageSleepingHoursAnswerServiceImpl(repository, quizService);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<AverageSleepingHoursAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<AverageSleepingHoursAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, AverageSleepingHoursAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, AverageSleepingHoursAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
