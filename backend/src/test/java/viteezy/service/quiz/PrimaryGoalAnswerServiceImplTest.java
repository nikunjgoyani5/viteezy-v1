...
class PrimaryGoalAnswerServiceImplTest {
    ...
    private static final PrimaryGoalAnswer SAMPLE_ENTITY = new PrimaryGoalAnswer(ID, QUIZ_ID, ALLERGY_ID, LocalDateTime.now(), LocalDateTime.now());
    ...
    private final PrimaryGoalAnswerRepository repository = Mockito.mock(PrimaryGoalAnswerRepository.class);
    private final QuizRepository quizRepository = Mockito.mock(QuizRepository.class);
    private PrimaryGoalAnswerService service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new PrimaryGoalAnswerServiceImpl(repository, quizRepository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<PrimaryGoalAnswer>> either = service.find(ID);
    ...
    void findByQuizExternalReference() {
        ...
        Either<Throwable, Optional<PrimaryGoalAnswer>> either = service.find(QUIZ_EXTERNAL_REFERENCE);
        Assertions.assertTrue(either.isRight());
        Assertions.assertTrue(either.get().isPresent());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get().get());
    ...
    void save() {
        ...
        Either<Throwable, PrimaryGoalAnswer> either = service.save(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
    ...
    void update() {
        ...
        Either<Throwable, PrimaryGoalAnswer> either = service.update(CATEGORIZED_ANSWER);
        Assertions.assertTrue(either.isRight());
        Assertions.assertEquals(SAMPLE_ENTITY, either.get());
