...
class MenstruationMoodServiceImplTest {
    ...
    private final MenstruationMoodRepository repository = Mockito.mock(MenstruationMoodRepository.class);
    private MenstruationMoodServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new MenstruationMoodServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<MenstruationMood>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<MenstruationMood>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, MenstruationMood> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
