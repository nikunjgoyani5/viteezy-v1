...
class IronPrescribedServiceImplTest {
    ...
    private final IronPrescribedRepository repository = Mockito.mock(IronPrescribedRepository.class);
    private IronPrescribedServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new IronPrescribedServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<IronPrescribed>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<IronPrescribed>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, IronPrescribed> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
