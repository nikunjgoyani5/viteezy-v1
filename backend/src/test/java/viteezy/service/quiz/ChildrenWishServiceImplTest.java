...
class ChildrenWishServiceImplTest {
    ...
    private final ChildrenWishRepository repository = Mockito.mock(ChildrenWishRepository.class);
    private ChildrenWishServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new ChildrenWishServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<ChildrenWish>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<ChildrenWish>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, ChildrenWish> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
