...
class DrySkinServiceImplTest {
    ...
    private final DrySkinRepository repository = Mockito.mock(DrySkinRepository.class);
    private DrySkinServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new DrySkinServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<DrySkin>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<DrySkin>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, DrySkin> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
