...
class LibidoStressLevelServiceImplTest {
    ...
    private final LibidoStressLevelRepository repository = Mockito.mock(LibidoStressLevelRepository.class);
    private LibidoStressLevelServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new LibidoStressLevelServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<LibidoStressLevel>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<LibidoStressLevel>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, LibidoStressLevel> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
