...
class VitaminOpinionServiceImplTest {
    ...
    private final VitaminOpinionRepository repository = Mockito.mock(VitaminOpinionRepository.class);
    private VitaminOpinionServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new VitaminOpinionServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<VitaminOpinion>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<VitaminOpinion>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, VitaminOpinion> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
