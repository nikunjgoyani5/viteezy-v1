...
class ${moduleNamePascalCase}AnswerControllerTest {
    ...
    private final ${moduleNamePascalCase}AnswerService service = Mockito.mock(${moduleNamePascalCase}AnswerService.class);
    private ${moduleNamePascalCase}AnswerController controller;

    @BeforeEach
    void setUp() {
        Mockito.reset(service);
        controller = new ${moduleNamePascalCase}AnswerController(service);
    }
    ...
    void find() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            Assertions.assertEquals(SAMPLE_ENTITY.getId(), ((${moduleNamePascalCase}AnswerGetResponse)response.getEntity()).getId());
