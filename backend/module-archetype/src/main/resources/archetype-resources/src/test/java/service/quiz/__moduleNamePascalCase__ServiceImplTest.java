...
class ${moduleNamePascalCase}ServiceImplTest {
    ...
    private final ${moduleNamePascalCase}Repository repository = Mockito.mock(${moduleNamePascalCase}Repository.class);
    private ${moduleNamePascalCase}ServiceImpl service;

    @BeforeEach
    void setUp() {
        Mockito.reset(repository);
        service = new ${moduleNamePascalCase}ServiceImpl(repository);
    }
    ...
    void find() {
        ...
        Either<Throwable, Optional<${moduleNamePascalCase}>> either = service.find(ID);
    ...
    void findAllOk() {
        ...
        Either<Throwable, List<${moduleNamePascalCase}>> either = service.findAll();
        Assertions.assertTrue(either.isRight());
    ...
    void save() {
        ...
        Either<Throwable, ${moduleNamePascalCase}> either = service.save(SAMPLE_ENTITY);
        Assertions.assertTrue(either.isRight());
