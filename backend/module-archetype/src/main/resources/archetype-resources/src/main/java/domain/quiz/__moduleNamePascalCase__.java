...
public class ${moduleNamePascalCase} {
    ...
    public boolean equals(Object o) {
        ...
        ${moduleNamePascalCase} ${moduleNameCamelCase} = (${moduleNamePascalCase}) o;
        return Objects.equals(id, ${moduleNameCamelCase}.id) &&
                Objects.equals(name, ${moduleNameCamelCase}.name) &&
                Objects.equals(code, ${moduleNameCamelCase}.code) &&
    ...
    public String toString() {
        return new StringJoiner(", ", ${moduleNamePascalCase}.class.getSimpleName() + "[", "]")
                .add("id=" + id)
                .add("name='" + name + "'")
                .add("code='" + code + "'")
